...
class TeamList {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is TeamList && other.teams == teams;

  @override
  int get hashCode => (teams == null ? 0 : teams.hashCode);
  ...
  static List<TeamList> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, List<TeamList>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = TeamList.listFromJson(v,
