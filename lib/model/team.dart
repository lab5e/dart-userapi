...
class Team {
  ...
  @override
  String toString() =>
      'Team[teamId=$teamId, isPrivate=$isPrivate, tags=$tags, members=$members]';
  ...
  static Map<String, List<Team>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] =
            Team.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
