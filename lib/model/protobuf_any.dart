...
class ProtobufAny {
  ...
  bool operator ==(Object other) =>
      ...
      other is ProtobufAny && other.typeUrl == typeUrl && other.value == value;
  ...
  static List<ProtobufAny> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, ProtobufAny> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = ProtobufAny.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ProtobufAny-objects as value to a dart map
  static Map<String, List<ProtobufAny>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ProtobufAny.listFromJson(v,
