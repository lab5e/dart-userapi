...
class MemberList {
  ...
  static List<MemberList> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <MemberList>[]
      : json.map((v) => MemberList.fromJson(v)).toList(growable: true == growable);

  static Map<String, MemberList> mapFromJson(Map<String, dynamic> json) {
    final map = <String, MemberList>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = MemberList.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of MemberList-objects as value to a dart map
  static Map<String, List<MemberList>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<MemberList>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = MemberList.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
