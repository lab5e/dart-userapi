...
class InviteList {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is InviteList && other.invites == invites;

  @override
  int get hashCode => (invites == null ? 0 : invites.hashCode);
  ...
  static List<InviteList> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, InviteList> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = InviteList.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of InviteList-objects as value to a dart map
  static Map<String, List<InviteList>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = InviteList.listFromJson(v,
