...
class InviteRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is InviteRequest && other.teamId == teamId && other.code == code;
  ...
  static List<InviteRequest> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <InviteRequest>[]
          : json
              .map((v) => InviteRequest.fromJson(v))
  ...
  static Map<String, InviteRequest> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = InviteRequest.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of InviteRequest-objects as value to a dart map
  static Map<String, List<InviteRequest>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = InviteRequest.listFromJson(v,
