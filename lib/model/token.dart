...
class Token {
  ...
  @override
  String toString() => 'Token[resource=$resource, write=$write, token=$token, tags=$tags, lastUse=$lastUse, uses=$uses]';
  ...
  static List<Token> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <Token>[]
      : json.map((v) => Token.fromJson(v)).toList(growable: true == growable);
  ...
  static Map<String, List<Token>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<Token>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = Token.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
